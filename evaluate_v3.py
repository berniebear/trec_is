...
def main(weight):
    ...
    ground_truth_label_dir = "data/2019ALabels/"
    ...
    ontologyFile = "data/ITR-H.types.v3.json"
    ...
    for categoryId in informationTypes2Index.keys():
        categoryPrecision = precision_score(category2GroundTruth[categoryId], category2Predicted[categoryId],
                                            average='binary')
        categoryRecall = recall_score(category2GroundTruth[categoryId], category2Predicted[categoryId],
                                      average='binary')
    ...
    #         avgRecall / len(informationTypes2Index)) + "\n")
    #     perEventFile.write(
    #         "  Information Type F1 (positive class, multi-type, macro): " + str(avgF1 / len(informationTypes2Index)) + "\n")
    ...
    for eventId in eventIdentifiers:
        ...
        for categoryId in informationTypes2Index.keys():
            avgF1 = avgF1 + f1_score(event2groundtruth[eventId].get(categoryId),
                                     event2prediction[eventId].get(categoryId),
                                     average='binary')
